...
import andarBaharImage from "@/assets/casino-andarbahar.jpg";
...
const AndarBahar = () => (
  <GamePageTemplate
    ...
    imageAlt="Andar Bahar online real money game on yolo365admin.live with live Indian dealer"
    gameImage={andarBaharImage}
    highlights={[
